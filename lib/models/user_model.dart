...
class UserModel extends Model {
  ...
  Future<void> updateProfile({
    ...
    Map<String, dynamic>? profilePreferences,
    double? maxDistance,
    int? minPreferredAge,
    int? maxPreferredAge,
    bool? hideProfile,
    ...
    String? identityVisibility,
    String? interestsVisibility,
  }) async {
    final mergedPreferences = {...?user.preferences, ...?profilePreferences};
    ...
    updateUserData(
          ...
          data: {
            ...
            USER_SHOW_PROFILE_BIO: !(hideProfile ?? false),
            USER_RACE_DEMOGRAPHICS: demographics,
            USER_FAMILY_PLANNING: familyPlanning,
            USER_FINANCIAL_READINESS: financialReadiness,
            USER_DESIRED_CHILDREN_COUNT: desiredChildrenCount,
            USER_HEIGHT_CM: heightCm,
            USER_WEIGHT_KG: weightKg,
            USER_HAS_CHILDREN: hasChildren,
            USER_CHILDREN_COUNT: childrenCount,
            USER_WANTS_CHILDREN: wantsChildren,
            USER_SMOKING_HABIT: smokingHabit,
            USER_ALCOHOL_HABIT: alcoholHabit,
            USER_PREFERENCES: mergedPreferences,
            '$USER_SETTINGS.$USER_MAX_DISTANCE': maxDistance,
            '$USER_SETTINGS.$USER_MIN_AGE': minPreferredAge,
            '$USER_SETTINGS.$USER_MAX_AGE': maxPreferredAge,
            '$USER_SETTINGS.$USER_VISIBILITY_PROFILE_PHOTO':
                profilePhotoVisibility,
            '$USER_SETTINGS.$USER_VISIBILITY_GALLERY': galleryVisibility,
            '$USER_SETTINGS.$USER_VISIBILITY_IDENTITY': identityVisibility,
            '$USER_SETTINGS.$USER_VISIBILITY_INTERESTS': interestsVisibility,
            USER_FULLNAME: userFullName,
            USER_BIRTH_DAY: userBirthDay,
            USER_BIRTH_MONTH: userBirthMonth,
            USER_BIRTH_YEAR: userBirthYear,

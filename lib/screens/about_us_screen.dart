...
class AboutScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(i18n.translate('about_us'))),
        ...
        child: Center(
          child: Column(
            children: <Widget>[
              ...
              const SizedBox(height: 10),
              TextButton.icon(
                style: TextButton.styleFrom(backgroundColor: APP_PRIMARY_COLOR),
                icon: const Icon(Icons.share, color: Colors.white),
                label: Text(
                  i18n.translate('share_app'),
              ...
              Column(
                ...
                children: <Widget>[
                  // Contact
                  Text(
                    i18n.translate('do_you_have_a_question'),
                  ...
                  const SizedBox(height: 10),
                  Text(
                    i18n.translate('send_your_message_to_our_email_address'),
                    style: const TextStyle(fontSize: 18),
                    textAlign: TextAlign.center,
                  ),
                  Text(
                    AppModel().appInfo.appEmail,
                    style: TextStyle(
                      fontSize: 18,
                      fontWeight: FontWeight.bold,

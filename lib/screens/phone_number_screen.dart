...
import 'package:datecinity/screens/verification_code_screen.dart';
...
class PhoneNumberScreenState extends State<PhoneNumberScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: _scaffoldkey,
      appBar: AppBar(title: Text(_i18n.translate("phone_number"))),
    ...
    await UserModel().verifyPhoneNumber(
      ...
      codeSent: (code) async {
        ...
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) => VerificationCodeScreen(verificationId: code),
          ),
        );
      },

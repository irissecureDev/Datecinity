...
class DislikedProfilesScreen extends StatefulWidget {
  const DislikedProfilesScreen({super.key});

  @override
  DislikedProfilesScreenState createState() => DislikedProfilesScreenState();
}

class DislikedProfilesScreenState extends State<DislikedProfilesScreen> {
  // Variables

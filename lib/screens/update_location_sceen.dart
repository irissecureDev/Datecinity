...
class UpdateLocationScreen extends StatefulWidget {
  ...
  // Conastructor
  const UpdateLocationScreen({super.key, this.isSignUpProcess = true});
...
class UpdateLocationScreenState extends State<UpdateLocationScreen> {
  ...
  void _nextScreen(dynamic screen) {
    ...
    // while the Navigator is mid-rebuild.
  ...
  void _showTimeoutErrorMessage(BuildContext context) async {
    ...
    final String message =
        "${_i18n.translate("we_are_unable_to_get_your_device_current_location")}, ${_i18n.translate("please_make_sure_to_enable_location_services_on_your_device_and_try_again")}";
    // Show error messag
    Future(() => errorDialog(context, message: message));
  }
  ...
  void _showFailErrorMessage(BuildContext context) async {
    ...
    // Get error message
    final String message =
        "${_i18n.translate("we_are_unable_to_get_your_device_current_location")}, ${_i18n.translate("please_skip_and_try_again_later_in_app_settings")}";
    // Show error messag
    Future(() => errorDialog(context, message: message));
  }

...
class ConversationsTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        /// Header
        BuildTitle(svgIconName: 'message_icon', title: i18n.translate("chats")),
                      ...
                      child: ListTile(
                        ...
                        subtitle: conversation[MESSAGE_TYPE] == 'text'
                            ? Text(
                                ...
                                "${timeago.format(conversation[TIMESTAMP]?.toDate() ?? DateTime.now())}",
                              )
                            : Row(
                        ...
                        onTap: () async {
                          ...
                          final userDoc = await UserModel().getUser(
